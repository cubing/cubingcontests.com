  ...
  return (
    <div className="px-3">
      ...
      <p>
        ...
        meant to be done in a competition-like setting, but instead need to be submitted individually. Contact{' '}
        {C.contactEmail} if you would like to submit a result.
      </p>
