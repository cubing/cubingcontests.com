    ...
    <div>
      ...
      <div className="mt-4">
        ...
        <p>
          ...
          requires admin approval. If you would like to hold a completely new event, you may request for it to be added,
          but this should be done before your contest is approved.
        </p>
        <p>
