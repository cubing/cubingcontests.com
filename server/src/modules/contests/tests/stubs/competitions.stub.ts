...
import { ContestState, ContestType, RoundFormat, RoundType, WcaRecordType } from "~/helpers/enums";
  ...
  return [
              ...
              results: [
                {
                  ...
                  personIds: [3],
                  ranking: 1,
                  attempts: [{ result: 2789 }, { result: 2719 }, {
                    result: -1,
                  }],
                  best: 2719,
                  average: -1,
                ...
                },
                {
                  ...
                  personIds: [5],
                  ranking: 3,
                  attempts: [{ result: 7086 }, { result: 7922 }, {
                    result: 6237,
                  }],
                  best: 6237,
                  average: 7082,
    ...
    },
    {
      ...
      events: [
              ...
              results: [
                {
                  ...
                  personIds: [5],
                  ranking: 1,
                  attempts: [{ result: 15299 }, { result: 14398 }, {
                    result: 14084,
                  }],
                  best: 14084,
                  average: 14594,
                ...
                },
                {
                  ...
                  personIds: [1],
                  ranking: 2,
                  attempts: [{ result: 20168 }, { result: 21170 }, {
                    result: 19841,
                  }],
                  best: 19841,
                  average: 20393,
                ...
                },
                {
                  ...
                  personIds: [4],
                  ranking: 3,
                  attempts: [{ result: 25127 }, { result: 22765 }, {
                    result: 20540,
                  }],
                  best: 20540,
                  average: 22811,
                ...
                },
                {
                  ...
                  personIds: [3],
                  ranking: 4,
                  attempts: [{ result: 23023 }, { result: -1 }, {
                    result: 22636,
                  }],
                  best: 22636,
                  average: -1,
              ...
              results: [
                {
                  ...
                  personIds: [3],
                  ranking: 1,
                  attempts: [{ result: 2758 }, { result: 2302 }, {
                    result: 3324,
                  }],
                  best: 2302,
                  average: 2795,
        ...
        {
          event: eventsSeed.find((el) => el.eventId === "333-team-factory"),
          rounds: [
            {
